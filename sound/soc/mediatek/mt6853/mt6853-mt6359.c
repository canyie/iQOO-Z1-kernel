...
#include "../../vivo/tfa9894/tfa98xx.h"
#endif
/*
...
static int mt6853_i2s_enable_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6853_i2s_enable_set(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static const struct snd_kcontrol_new mt6853_mt6359_controls[] = {
	...
	SOC_ENUM_EXT("Vivo MI2S Clock", mtk_i2s_enum[0],
		     mt6853_i2s_enable_get, mt6853_i2s_enable_set),
};
...
static void mtk_i2s3_config_for_calibration(struct mtk_base_afe *afe, bool enable)
{
	...
	if (enable) {
		...
		/* Config I2S3 gpio */
		mt6853_afe_gpio_request(afe, true, MT6853_DAI_I2S_3, 0);
		...
		/* Config I2S3 gpio */
		mt6853_afe_gpio_request(afe, false, MT6853_DAI_I2S_3, 0);
