...
struct mt_asoc_data{
	...
	struct pinctrl_state *i2s3_defaul_gpio_state;
	struct pinctrl_state *i2s3_mode_state;
	struct pinctrl_state *tfa_dat_ref_default;
	struct pinctrl_state *tfa_dat_ref_in_i2s;
	struct pinctrl_state *i2s1_default_gpio_state;
	struct pinctrl_state *i2s1_mode_state;
};
