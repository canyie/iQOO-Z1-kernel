...
{
	/* defaults */
	ops->reg_read = tfa98xx_read_register16_v1;
	ops->reg_write = tfa98xx_write_register16_v1;
	ops->mem_read = tfa98xx_dsp_read_mem_v1;
	ops->mem_write = tfa98xx_dsp_write_mem_word_v1;
	ops->dsp_msg = tfa_dsp_msg_v1;
	ops->dsp_msg_read = tfa_dsp_msg_read_v1;
...
static enum Tfa98xx_Error tfa9912_faim_protect(struct tfa_device *tfa, int status)
{
	...
	if (tfa) {
		if (status == 0 || status == 1) {
			ret = -(tfa_set_bf_v1(tfa, TFA9912_BF_SSFAIME, (uint16_t)status));
		}
	}
...
static int tfa9912_set_swprofile(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9912_BF_SWPROFIL, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9912_BF_SWPROFIL) - 1;
}
...
static int tfa9912_set_swvstep(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9912_BF_SWVSTEP, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9912_BF_SWVSTEP) - 1;
}

static enum Tfa98xx_Error
tfa9912_set_mute(struct tfa_device *tfa, int mute)
{
	tfa_set_bf_v1(tfa, TFA9912_BF_CFSM, (const uint16_t)mute);
...
static uint16_t tfa9912_vboost_fixup(struct tfa_device *tfa, uint16_t dcdc_cnt6)
{
	...
	boost_v_1st = tfa_get_bf_value_v1(TFA9912_BF_DCVOF, new_dcdc_cnt6);
	boost_v_2nd = tfa_get_bf_value_v1(TFA9912_BF_DCVOS, new_dcdc_cnt6);
	...
	tfa_set_bf_value_v1(TFA9912_BF_DCVOF, boost_v_1st, &new_dcdc_cnt6);
	tfa_set_bf_value_v1(TFA9912_BF_DCVOS, boost_v_2nd, &new_dcdc_cnt6);
...
enum Tfa98xx_Error tfa9912_reg_write(struct tfa_device *tfa, unsigned char subaddress, unsigned short value)
{
	...
	return tfa98xx_write_register16_v1(tfa, subaddress, value);
}
...
{
	if (state == 1 || state == 0) {
		return -tfa_set_bf_v1(tfa, TFA9912_BF_MANAOOSC, (uint16_t) state);
	}
...
static enum Tfa98xx_Error tfa9872_specific(struct tfa_device *tfa)
{
	...
	error = tfa_set_bf_v1(tfa, MANAOOSC, 1);
...
static int tfa9872_set_swprofile(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9872_BF_SWPROFIL, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9872_BF_SWPROFIL) - 1;
}
...
static int tfa9872_set_swvstep(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9872_BF_SWVSTEP, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9872_BF_SWVSTEP) - 1;
}
...
static enum Tfa98xx_Error tfa9874_faim_protect(struct tfa_device *tfa, int status)
{
	...
	ret = tfa_set_bf_volatile_v1(tfa, TFA9874_BF_OPENMTP, (uint16_t)(status));
	return ret;
}
...
static int tfa9874_set_swprofile(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9874_BF_SWPROFIL, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9874_BF_SWPROFIL) - 1;
}
...
static int tfa9874_set_swvstep(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9874_BF_SWVSTEP, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9874_BF_SWVSTEP) - 1;
}
...
static enum Tfa98xx_Error tfa9874_dsp_system_stable(struct tfa_device *tfa, int *ready)
{
	...
	*ready = tfa_get_bf_v1(tfa, TFA9874_BF_CLKS) == 1;
...
static int tfa9874_get_mtpb(struct tfa_device *tfa) 
{
	...
	int value;
	value = tfa_get_bf_v1(tfa, TFA9874_BF_MTPB);
	return value;
}
...
static enum Tfa98xx_Error tfa9896_faim_protect(struct tfa_device *tfa, int status)
{
	...
	if ((tfa->rev  == 0x2b96) || (tfa->rev == 0x3b96)) {
		ret = tfa_set_bf_volatile_v1(tfa, TFA9896_BF_OPENMTP, (uint16_t)status);
	}
...
{
	return tfa_dsp_cmd_id_write_v1(tfa, MODULE_FRAMEWORK, TFA1_FW_PAR_ID_SET_CURRENT_DELAY, sizeof(tfa9896_vsfwdelay_table), tfa9896_vsfwdelay_table);
}
...
{
	return tfa_dsp_cmd_id_write_v1(tfa, MODULE_FRAMEWORK, TFA1_FW_PAR_ID_SET_CURFRAC_DELAY, sizeof(tfa9896_cvfracdelay_table), tfa9896_cvfracdelay_table);;
}
...
{
	return tfa_dsp_cmd_id_write_v1(tfa, MODULE_FRAMEWORK, TFA1_FW_PAR_ID_SET_CURRENT_DELAY, sizeof(tfa9897_vsfwdelay_table), tfa9897_vsfwdelay_table);;
}
...
{
	return tfa_dsp_cmd_id_write_v1(tfa, MODULE_FRAMEWORK, TFA1_FW_PAR_ID_SET_CURFRAC_DELAY, sizeof(tfa9897_cvfracdelay_table), tfa9897_cvfracdelay_table);;
}
...
static int tfa9894_set_swprofile(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9894_BF_SWPROFIL, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9894_BF_SWPROFIL) - 1;
}
...
static int tfa9894_set_swvstep(struct tfa_device *tfa, unsigned short new_value)
{
	...
	/* Set the new value in the hw register */
	tfa_set_bf_volatile_v1(tfa, TFA9894_BF_SWVSTEP, new_value);
...
{
	return tfa_get_bf_v1(tfa, TFA9894_BF_SWVSTEP) - 1;
}
...
static int tfa9894_get_mtpb(struct tfa_device *tfa) 
{
	...
	/* Set the new value in the hw register */
	value = tfa_get_bf_v1(tfa, TFA9894_BF_MTPB);
...
{
	if (state == 1 || state == 0) {
		return -tfa_set_bf_v1(tfa, TFA9894_BF_MANAOOSC, (uint16_t)state);
	}
...
static enum Tfa98xx_Error tfa9894_faim_protect(struct tfa_device *tfa, int status)
{
	enum Tfa98xx_Error ret = Tfa98xx_Error_Ok;
	/* 0b = FAIM protection enabled 1b = FAIM protection disabled*/
	ret = tfa_set_bf_volatile_v1(tfa, TFA9894_BF_OPENMTP, (uint16_t)(status));
	return ret;
}
...
{
	tfa_set_bf_v1(tfa, TFA9894_BF_CFSM, (const uint16_t)mute);
...
static enum Tfa98xx_Error tfa9894_dsp_system_stable(struct tfa_device *tfa, int *ready)
{
	...
	/* check CLKS: ready if set */
	*ready = tfa_get_bf_v1(tfa, TFA9894_BF_CLKS) == 1;
