...
enum Tfa98xx_Error {
	...
	Tfa98xx_Error_container,		/* 11. if a buffer is too small */
 ...
 */
enum Tfa98xx_Error tfa98xx_set_volume_level_v1(struct tfa_device *tfa, 
				  unsigned short vol);
 ...
 */
enum Tfa98xx_Error tfa98xx_select_mode_v1(struct tfa_device *tfa,  enum Tfa98xx_Mode mode);

/* mute/unmute the audio
 * @param mute see Tfa98xx_Mute_t enumeration
 */
enum Tfa98xx_Error tfa98xx_set_mute_v1(struct tfa_device *tfa, 
 ...
 */
enum Tfa98xx_Error 
tfa98xx_compare_features_v1(struct tfa_device *tfa,  int features_from_MTP[3], int features_from_cnt[3]);
 ...
 */
enum Tfa98xx_Error tfa_dsp_patch_v1(struct tfa_device *tfa, 
				 int patchLength, 
 ...
 */
enum Tfa98xx_Error tfa98xx_dsp_write_speaker_parameters_v1(
 ...
 */
enum Tfa98xx_Error tfa98xx_dsp_get_state_info_v1(
				struct tfa_device *tfa,  
				unsigned char bytes[], 
 ...
 */
enum Tfa98xx_Error tfa98xx_dsp_support_drc_v1(struct tfa_device *tfa, 
											int *pbSupportDrc);
 ...
 */
enum Tfa98xx_Error tfa98xx_dsp_write_preset_v1(struct tfa_device *tfa, 
...
*/
enum Tfa98xx_Error Tfa98xx_DspBiquad_Disable_v1(struct tfa_device *tfa, 
											int biquad_index);
 ...
 */
enum Tfa98xx_Error
tfa_dsp_get_calibration_impedance_v1(struct tfa_device *tfa);
...
*/
enum Tfa98xx_Error tfa98xx_dsp_read_mem_v1(struct tfa_device *tfa, 
...
*/
enum Tfa98xx_Error tfa98xx_dsp_write_mem_word_v1(struct tfa_device *tfa, 
...
*/
enum Tfa98xx_Error tfa98xx_write_data_v1(struct tfa_device *tfa, 
				  unsigned char subaddress, 
				  int num_bytes, 
				  const unsigned char data[]);
...
enum Tfa98xx_Error tfa98xx_dsp_write_config_v1(struct tfa_device *tfa,  int length,  const unsigned char *p_config_bytes);
enum Tfa98xx_Error tfa98xx_dsp_write_drc_v1(struct tfa_device *tfa,  int length,  const unsigned char *p_drc_bytes);
...
#define TFA_SET_BF(tfa,  fieldname,  value) tfa_set_bf_v1(tfa,  TFA_FAM(tfa,  fieldname), value)
#define TFA_SET_BF_VOLATILE(tfa,  fieldname,  value) tfa_set_bf_volatile_v1(tfa,  TFA_FAM(tfa,  fieldname), value)
#define TFA_GET_BF(tfa,  fieldname) tfa_get_bf_v1(tfa,  TFA_FAM(tfa,  fieldname))

/* set/get bit field in variable */
#define TFA_SET_BF_VALUE(tfa,  fieldname,  bf_value,  p_reg_value) tfa_set_bf_value_v1(TFA_FAM(tfa,  fieldname), bf_value,  p_reg_value)
#define TFA_GET_BF_VALUE(tfa,  fieldname,  reg_value) tfa_get_bf_value_v1(TFA_FAM(tfa,  fieldname), reg_value)

/* write/read registers using a bit field name to determine the register address */
#define TFA_WRITE_REG(tfa,  fieldname,  value) tfa_write_reg_v1(tfa,  TFA_FAM(tfa,  fieldname), value)
#define TFA_READ_REG(tfa,  fieldname) tfa_read_reg_v1(tfa,  TFA_FAM(tfa,  fieldname))
