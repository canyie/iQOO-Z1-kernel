...
//#define CONFIG_TISA_DEBUGFS_INTF 1
//#define CONFIG_TISA_BIN_INTF 1
...
#define TAS_RX_PORT		0x1004 /* TERT MI2S RX */
#define TAS_TX_PORT		0x1005 /* TERT MI2S TX */
#else
...
void tas_smartamp_add_algo_controls (struct snd_soc_codec *codec, int number_of_channels);
