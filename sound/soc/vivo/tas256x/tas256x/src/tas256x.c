...
int tas256x_set_iv_slot(struct tas256x_priv *p_tas256x, int ch, int vslot, int islot)
{
	...
	n_result |= p_tas256x->write(p_tas256x, ch, TAS256X_TDMCONFIGURATIONREG5,
		vslot);

	n_result |= p_tas256x->write(p_tas256x, ch, TAS256X_TDMCONFIGURATIONREG6,
		islot);
...
int tas256x_set_vbat_slot(struct tas256x_priv *p_tas256x, int ch, int slot)
{
	...
	n_result |= p_tas256x->write(p_tas256x, ch, TAS256X_TDMCONFIGURATIONREG7,
		slot);
