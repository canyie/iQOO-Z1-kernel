...
#define TAS2562_BOOSTCONFIGURATION_PEAKCURRENTLIMIT TAS2562_REG(0x0, 0x0, 0x40)
#define TAS2562_BOOSTCONFIGURATION_PEAKCURRENTLIMIT_MASK  (0xff << 0)

#define TAS2562_ICN_REG TAS2562_REG(0x0, 0x2, 0x64)
#define TAS2562_DELAY_REG TAS2562_REG(0x0, 0x2, 0x6c)
...
struct kobject *kobj; /* wangkai add for AT mode */

/* Add this for setting special regs according to different producton */
	int reg_size;
	int *reg_table;
};
