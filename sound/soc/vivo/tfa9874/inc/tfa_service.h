...
*/
enum Tfa98xx_Error Tfa98xx_DspBiquad_Disable(struct tfa_device *tfa, int biquad_index);
 ...
 * @param bytes output data as unsigned char array
*/
enum Tfa98xx_Error tfa98xx_dsp_get_memory(struct tfa_device *tfa, int memoryType, int offset, int length, unsigned char bytes[]);
...
*/
enum Tfa98xx_Error tfa98xx_dsp_set_memory(struct tfa_device *tfa, int memoryType, int offset, int length, int value);
...
enum Tfa98xx_Error tfa_dsp_cmd_set_f0(struct tfa_device *tfa, 
					unsigned char module_id, 
					unsigned char param_id, 
					int channel_count);
enum Tfa98xx_Error tfa_dsp_cmd_get_f0(struct tfa_device *tfa, 
					unsigned char module_id, 
					unsigned char param_id, 
					int channel_count, 
					unsigned char data[]);
