...
static void lcm_suspend_power(void)
{
	...
	lcm_enp_setting(0);
	MDELAY(5);
	LCM_INFO("[LCM]lcm_suspend_power txd nt36525- vddi keep high level\n");
	panel_reset_state = 0;
	LCM_INFO("\n");
}
...
{
	if (lcm_software_id == 0x40)
		return 0xA1;
	else
		return 0xFF;
}

struct LCM_DRIVER pd2066_nt36525b_fhdplus_dsi_vdo_txd_lcm_drv = {
	.name = "pd2066_nt36525b_fhdplus_dsi_vdo_txd",
