...
#include "../../../../../vivo/system/display/vivosrc/fb/pd2103_tm658_nt36672c_fhdplus_video_cmd.h"
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	} else if (!level && bl_brightness_hal){
...
{
	if (lcm_software_id == 0x48)
		return 0x12;
	else
		return 0xFF;
}

struct LCM_DRIVER pd2103_tm658_nt36672c_fhdplus_lcm_drv = {
	.name = "pd2103_tm658_nt36672c_fhdplus_drv",
