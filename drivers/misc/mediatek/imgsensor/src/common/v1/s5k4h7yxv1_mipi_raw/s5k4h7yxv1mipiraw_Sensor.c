...
#define PFX "S5K4H7YXV1_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7YXV1_SENSOR_ID,
...
extern int S5K4H7YXV1_otp_read(void);
int vivo_sub_otp_read_when_power_on_s5k4h7yxv1;
extern otp_error_code_t S5K4H7YXV1_OTP_ERROR_CODE;
extern unsigned int is_atboot;
MUINT32  sn_inf_sub_s5k4h7yxv1[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5k4h7yxv1[4];  /*0 flag   1-12 data*/
...
kal_uint16 addr_data_pair_init_s5k4h7yxv1[] = {
0x0100, 0x00,
0x0B05, 0x01,
0x3074, 0x06,
0x3075, 0x2F,
...
kal_uint16 addr_data_pair_preview_s5k4h7yxv1[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_capture_s5k4h7yxv1[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7yxv1[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7yxv1[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7yxv1[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7yxv1,
                          sizeof(addr_data_pair_init_s5k4h7yxv1) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7yxv1,
                          sizeof(addr_data_pair_preview_s5k4h7yxv1) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7yxv1,
                          sizeof(addr_data_pair_capture_s5k4h7yxv1) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7yxv1,
                          sizeof(addr_data_pair_normal_video_s5k4h7yxv1) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7yxv1,
                          sizeof(addr_data_pair_hs_video_s5k4h7yxv1) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7yxv1,
                          sizeof(addr_data_pair_slim_video_s5k4h7yxv1) / sizeof(kal_uint16));
    ...
    do {
      *sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001)) + 1;
      ...
      if (*sensor_id == imgsensor_info.sensor_id) {
        ...
        pr_debug("add:start read eeprom  - when_power_on  = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7yxv1);
       sensor_init();
        vivo_sub_otp_read_when_power_on_s5k4h7yxv1=S5K4H7YXV1_otp_read();
         ...
         *	pr_debug(
         *	"sp8Flag(0x%x),0x5003 used by s5k4h7yxv1\n", sp8spFlag);
         *
         *	if (sp8spFlag == 0x5003) {
         *		pr_debug("it is s5k4h7yxv1\n");
         *		return ERROR_NONE;
         *	}
         *
         *		pr_debug(
                                  ...
                                  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		case 0:    //info type: otp state
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K4H7YXV1_OTP_ERROR_CODE;//otp_state
			memcpy(feature_data+2, sn_inf_sub_s5k4h7yxv1, sizeof(MUINT32)*13);
			memcpy( feature_data+10, material_inf_sub_s5k4h7yxv1, sizeof(MUINT32)*4); 
			break;
		}
		break;
		/******************** PDAF END   <<< *********/
...
UINT32 S5K4H7YXV1_MIPI_RAW_SensorInit(
