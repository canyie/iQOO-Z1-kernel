...
#define PFX "IMX471PD1913_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
		.sensor_id = IMX471PD1913_SENSOR_ID,
		...
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_B, /*SENSOR_OUTPUT_FORMAT_RAW_Gr*/
...
{ 4608, 3456, 0, 0, 4608, 3456, 4608, 3456,  0, 0, 4608, 3456, 0, 0, 4608, 3456 },/*capture sw-remosiac*/
{ 4608, 3456, 0, 0, 4608, 3456, 2304, 1728,  0, 0, 2304, 1728, 0, 0, 2304, 1728 },/*normal-video*/
{ 4608, 3456, 0, 0, 4608, 3456, 2304, 1728,  0, 0, 2304, 1728, 0, 0, 2304, 1728 }, /* hs-video*/
{ 4608, 3456, 0, 0, 4608, 3456, 2304, 1728,  0, 0, 2304, 1728, 0, 0, 2304, 1728 }, /* slim-video*/
{ 4608, 3456, 0, 0, 4608, 3456, 2304, 1728,  0, 0, 2304, 1728, 0, 0, 2304, 1728 },/*custom1*/
{ 4608, 3456, 0, 0, 4608, 3456, 2304, 1728,  0, 0, 2304, 1728, 0, 0, 2304, 1728 },/*custom2*/
...
extern int IMX471PD1913_otp_read(void);
static int vivo_otp_read_when_power_on;
extern unsigned int is_atboot;
extern otp_error_code_t IMX471PD1913_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_imx471pd1913[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_imx471pd1913[4];
#define FOUR_CELL_QSC_SIZE 560
#define FOUR_CELL_DPC_SIZE 935
#define FOUR_CELL_FD_DPC_SIZE 16
extern unsigned char QSC_DATA[830];
static unsigned char DPC_DATA[954];
/****hope add end****/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("imx471pd1913mipiraw_Sensor I2C_BUS = %d\n", I2C_BUS);	
	if(I2C_BUS != 4){	
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = IMX471PD1913_otp_read();
				LOG_INF("lxd_add:end read eeprom ---vivo_otp_read_when_power_on = %d,IMX471PD1913_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, IMX471PD1913_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  IMX471PD1913_OTP_ERROR_CODE:%d \n", *feature_data,IMX471PD1913_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = IMX471PD1913_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_imx471pd1913, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_imx471pd1913, sizeof(MUINT32)*4);
				#if 0
						for (i = 0 ; i<13 ; i++ )
							LOG_INF("sn_inf_sub_imx471pd1913[%d]= 0x%x\n", i, sn_inf_sub_imx471pd1913[i]);
				#endif
			}
				break;
		}
...
UINT32 IMX471PD1913_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!= NULL)
		*pfFunc= &sensor_func;
	return ERROR_NONE;
}	/*	IMX471PD1913_MIPI_RAW_SensorInit	*/
