...
#include "gc02m1bPD2066BAmipimono_Sensor.h"
#include "../imgsensor_i2c.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC02M1BPD2066BA_camera_sensor"
#define LOG_1 LOG_INF("GC02M1BPD2066BA,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	/*.sensor_id = GC02M1BPD2066BA_SENSOR_ID, */
	.sensor_id = GC02M1BPD2066BA_SENSOR_ID,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 1x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 1.185x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 1.4x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 1.659x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 2.0x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 2.37x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 2.8x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 3.318x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 4.0x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 4.74x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 5.6x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 6.636x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 8.0x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 9.48x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066BAMIPI analogic gain 11.2x, GC02M1BPD2066BAMIPI add pregain = %d\n",
		     temp);
	}
	else {
		write_cmos_sensor(0xfe, 0x00);
...
UINT32 GC02M1BPD2066BA_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*    GC02M1BPD2066BA_MIPI_RAW_SensorInit    */
