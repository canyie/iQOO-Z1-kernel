...
#define PFX "MAIN[2103]_camera_sensor"
...
#include "s5kgw3sp13PD2103mipiraw_Sensor.h"
#include "../imgsensor_common.h"

#include "s5kgw3sp13PD2103mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGW3SP13PD2103_SENSOR_ID,
...
extern otp_error_code_t S5KGW3SP13_OTP_ERROR_CODE;
MUINT32  sn_inf_main_s5kgw3sp13[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kgw3sp13[4];
MUINT32  af_calib_inf_main_s5kgw3sp13[6];
...
static kal_uint32 get_sensor_temperature(void)
{
	...
	if (TMC_Shift_Value > 0x7FF ){
	  	PK_DBG("GW3 TMC Value is < 0 ,TMC is Disable \n");
	}
	else{
		 PK_DBG("GW3 TMC Value is ok \n");
	}
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGW3SP13_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kgw3sp13, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_s5kgw3sp13, sizeof(MUINT32)*4); 
				memcpy( feature_data+12, af_calib_inf_main_s5kgw3sp13, sizeof(MUINT32)*6);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_s5kgw3sp13[%d]= 0x%x\n", i, sn_inf_main_s5kgw3sp13[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGW3SP13PD2103_MIPI_RAW_SensorInit(
