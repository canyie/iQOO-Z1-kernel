...
#define PFX "S5K4H7YXPD2066A_EEPROM_OTP"
...
otp_error_code_t S5K4H7YXPD2066A_OTP_ERROR_CODE = OTP_ERROR_CODE_NORMAL;
unsigned  int S5K4H7YXPD2066A_flag;
extern MUINT32  sn_inf_sub_s5k4h7yxPD2066A[13];  /*0 flag   1-12 data*/
extern MUINT32  material_inf_sub_s5k4h7yxPD2066A[4];  /*0 flag   1-12 data*/
...
int S5K4H7YXPD2066A_otp_read(void)
{
	int i = 0;
	...
	S5K4H7YXPD2066A_OTP_ERROR_CODE = OTP_ERROR_CODE_NORMAL;
	...
	if (vivo_otp_data[0x09] != 0x00 ){
		S5K4H7YXPD2066A_OTP_ERROR_CODE = OTP_ERROR_CODE_MODULE_INFO_ERROR;
		S5K4H7YXPD2066A_flag = 0;
		LOG_INF("VCM ID Error!!!    S5K4H7YXPD2066A_flag =%d\n", S5K4H7YXPD2066A_flag);
	}else{
		S5K4H7YXPD2066A_flag = 1;
		LOG_INF("S5K4H7YXPD2066A_flag = %d,VCM ID = 0x%x", S5K4H7YXPD2066A_flag,vivo_otp_data[0x09]);
	}
	...
	if (check_if_group_valid == 0x01) //all the data is valid
	{
        ...
        {
			S5K4H7YXPD2066A_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
            LOG_INF("ModuleInfo_checksum error!!!   otp_error_code:%d\n",S5K4H7YXPD2066A_OTP_ERROR_CODE);
			return 0;
        }

		/****material info start****/
			material_inf_sub_s5k4h7yxPD2066A[0] = (MUINT32)vivo_otp_data[0x0F];
			material_inf_sub_s5k4h7yxPD2066A[1] = (MUINT32)vivo_otp_data[0x10];
			material_inf_sub_s5k4h7yxPD2066A[2] = (MUINT32)vivo_otp_data[0x11];
			material_inf_sub_s5k4h7yxPD2066A[3] = (MUINT32)vivo_otp_data[0x12];
			LOG_INF("material_inf_sub_s5k4h7yxPD2066A[0] = 0x%x, material_inf_sub_s5k4h7yxPD2066A[1] = 0x%x, material_inf_sub_s5k4h7yxPD2066A[2] = 0x%x,material_inf_sub_s5k4h7yxPD2066A[3] = 0x%x\n",
				material_inf_sub_s5k4h7yxPD2066A[0]  , material_inf_sub_s5k4h7yxPD2066A[1],  material_inf_sub_s5k4h7yxPD2066A[2], material_inf_sub_s5k4h7yxPD2066A[3]);
		/****material info end****/
		...
		sn_inf_sub_s5k4h7yxPD2066A[0] = 0x01;
		for(i = 0;i < 12;i++){
			sn_inf_sub_s5k4h7yxPD2066A[i +1] = (MUINT32)vivo_otp_data[i + SNInfo_addr+1];
			LOG_INF("sn_inf_sub_s5k4h7yxPD2066A[%d] = 0x%x, vivo_otp_data[0x%x] = 0x%x\n", i+1  , sn_inf_sub_s5k4h7yxPD2066A[i +1],  i +SNInfo_addr+1, vivo_otp_data[i + SNInfo_addr+1]);
		}
		//////AWB_checksum
		checksum = 0;
		...
		if(t > 0) 
		{
			S5K4H7YXPD2066A_OTP_ERROR_CODE = OTP_ERROR_CODE_AWB_OUT_OF_RANGE;
			LOG_INF("AWB[low cct] out of range error!!!This module range^2 *1024^2 is %lld%%   otp_error_code:%d\n", temp, S5K4H7YXPD2066A_OTP_ERROR_CODE);
			return 0;
		}
		...
		S5K4H7YXPD2066A_OTP_ERROR_CODE = OTP_ERROR_CODE_GROUP_INVALID;
