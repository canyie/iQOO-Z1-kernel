 ...
 *============================================================================
 ****************************************************************************/
#define PFX "OV13B10PD2066A_camera_sensor"
...
#include "ov13b10PD2066Amipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10PD2066A_SENSOR_ID,
...
extern int ov13b10PD2066A_vivo_otp_read(void);
extern bool vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
static int vivo_otp_read_when_power_on = 0;
MUINT32  sn_inf_main_ov13b10PD2066A[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_ov13b10PD2066A[4];  
extern otp_error_code_t OV13B10PD2066A_OTP_ERROR_CODE;
extern unsigned int is_atboot;
extern unsigned  int ov13b10PD2066A_flag;
...
static kal_uint16 ov13b10PD2066A_table_write_cmos_sensor(
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10PD2066A[] = {
0x0103, 0x01,
0x0303, 0x02,
0x0305, 0x56,
0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	mdelay(10);
	LOG_INF("MULTI_WRITE\n");
	ov13b10PD2066A_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10PD2066A,
		sizeof(addr_data_pair_init_ov13b10PD2066A) / sizeof(kal_uint16));
	LOG_INF("sensor_init() end\n");
}	/*	sensor_init  */

#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10PD2066A[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x06,
	0x3502, 0x10,
...
static void preview_setting(void)
{
	...
	ov13b10PD2066A_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10PD2066A,
		sizeof(addr_data_pair_preview_ov13b10PD2066A) / sizeof(kal_uint16));

	LOG_INF("preview_setting() end\n");
}	/*	preview_setting  */

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10PD2066A[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10PD2066A[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10PD2066A_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10PD2066A,
			sizeof(addr_data_pair_capture_15fps_ov13b10PD2066A) /
			sizeof(kal_uint16));
	} else {
		ov13b10PD2066A_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10PD2066A,
			sizeof(addr_data_pair_capture_30fps_ov13b10PD2066A) /
			sizeof(kal_uint16));
	}
}
...
#if MULTI_WRITE
#if 0
kal_uint16 addr_data_pair_video_ov13b10PD2066A[] = {//4208x3120
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x06,
	0x3502, 0x10,
...
#endif
kal_uint16 addr_data_pair_video_ov13b10PD2066A[] = {//4208x2368
0x0305, 0x56, 
0x0327, 0x05, 
0x3501, 0x0c, 
0x3502, 0x10, 
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov13b10PD2066A_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10PD2066A,
		sizeof(addr_data_pair_video_ov13b10PD2066A) /
		sizeof(kal_uint16));
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10PD2066A[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x03,
	0x3502, 0x00,
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10PD2066A[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x03,
	0x3502, 0x00,
...
static void hs_video_setting(void)
{
	...
	ov13b10PD2066A_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10PD2066A,
		sizeof(addr_data_pair_hs_video_ov13b10PD2066A) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	ov13b10PD2066A_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10PD2066A,
		sizeof(addr_data_pair_slim_video_ov13b10PD2066A) /
		sizeof(kal_uint16));
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
				*sensor_id = return_sensor_id();
				...
				if((int)material_inf_ov13b10[3] == 88) {
					...
					vivo_otp_read_when_power_on = ov13b10PD2066A_vivo_otp_read();
					return ERROR_NONE;
				}
			}
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
    	printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV13B10PD2066A_OTP_ERROR_CODE:%d \n", *feature_data,OV13B10PD2066A_OTP_ERROR_CODE);
		switch (*feature_data) {
			case 0:    //info type: otp state
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV13B10PD2066A_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main_ov13b10PD2066A, sizeof(MUINT32)*13); 	
					memcpy( feature_data+10, material_inf_main_ov13b10PD2066A, sizeof(MUINT32)*4); 
					#if 0
						for (i = 0 ; i<13 ; i++ ){
						printk("sn_inf_main_ov13b10PD2066BA[%d]= 0x%x\n", i, sn_inf_main_ov13b10PD2066A[i]);
						}
...
UINT32 OV13B10PD2066A_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
