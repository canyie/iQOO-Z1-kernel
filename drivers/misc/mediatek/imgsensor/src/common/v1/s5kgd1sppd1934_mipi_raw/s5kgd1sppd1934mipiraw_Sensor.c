...
#define PFX "S5KGD1SPPD1934_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
		.sensor_id = S5KGD1SPPD1934_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 6560, 4944,	  0,	8, 6560, 4928, 6560, 4928, 0000, 0000, 6560, 4928,	  0,	0, 6560, 4928}, //hw-remosiac capture
	
	{ 6560, 4944,	  16,	624, 6528, 3696, 3264,  1848, 0000, 0004, 3264,  1840,	  0,	0, 3264, 1840}, /*video*/
	{ 6560, 4944,     0,    0, 6560, 3024, 1640,  756, 0000, 0000, 1640,  756,    0,    0, 1632, 1224}, /*hs_video,don't use*/
	...
	{ 6560, 4944,     0,    0, 6560, 3024, 1640,  756, 0000, 0000, 1640,  756,    0,    0, 1632, 1224}, /* custom3*/
...
extern int s5kgd1sppd1934_otp_read(void);
MUINT32 vivo_s5kgd1sppd1934otp_read_when_power_on;
extern otp_error_code_t S5KGD1SPPD1934_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_s5kgd1sppd1934[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5kgd1sppd1934[4];
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("s5kgd1sppd1934mipiraw_Sensor I2C_BUS = %d\n", I2C_BUS);	
	if(I2C_BUS != 2){	
		...
		do {
			*sensor_id = read_cmos_sensor_16_8(0x0000) << 8 | read_cmos_sensor_16_8(0x0001) + 1;
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				LOG_INF("cfx_add:start read eeprom ---vivo_s5kgd1sppd1934otp_read_when_power_on = %d\n", vivo_s5kgd1sppd1934otp_read_when_power_on);
				vivo_s5kgd1sppd1934otp_read_when_power_on = s5kgd1sppd1934_otp_read();
				LOG_INF("cfx_add:end read eeprom ---vivo_s5kgd1sppd1934otp_read_when_power_on = %d,S5KGD1SPPD1934_OTP_ERROR_CODE =%d\n", vivo_s5kgd1sppd1934otp_read_when_power_on, S5KGD1SPPD1934_OTP_ERROR_CODE);
				/*vivo hope  add end*/
				return ERROR_NONE;
			}
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	#if 1
	    LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  S5KGD1SPPD1934_OTP_ERROR_CODE:%d \n", *feature_data,S5KGD1SPPD1934_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGD1SPPD1934_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_s5kgd1sppd1934, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_s5kgd1sppd1934, sizeof(MUINT32)*4);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						LOG_INF("sn_inf_sub_s5kgd1sppd1934[%d]= 0x%x\n", i, sn_inf_sub_s5kgd1sppd1934[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGD1SPPD1934_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!= NULL)
		*pfFunc= &sensor_func;
	return ERROR_NONE;
}	/*	S5KGD1SPPD1934_MIPI_RAW_SensorInit	*/
