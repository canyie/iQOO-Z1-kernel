...
#define PFX "hi846pd1913_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI846PD1913_SENSOR_ID,
...
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI846PD1913;
MUINT32  sn_inf_main3_hi846pd1913[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main3_hi846pd1913[4];
			...
			do {
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {				
					...
					LOG_INF("cfx_add:end read eeprom ---vivo_main3_otp_read_when_power_on = %d,MAIN3_OTP_ERROR_CODE_HI846PD1913 =%d\n", vivo_main3_otp_read_when_power_on,MAIN3_OTP_ERROR_CODE_HI846PD1913);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
	...
	break;
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OTP_ERROR_CODE_HI846PD1913:%d \n", *feature_data,MAIN3_OTP_ERROR_CODE_HI846PD1913);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI846PD1913;//otp_state
					memcpy( feature_data+2, sn_inf_main3_hi846pd1913, sizeof(MUINT32)*13);
					memcpy( feature_data+10, material_inf_main3_hi846pd1913, sizeof(MUINT32)*4);
					#if 0
							for (i = 0 ; i<12 ; i++ ){
							printk("sn_inf_main2_hi846pd1913[%d]= 0x%x\n", i, sn_inf_main2_hi846pd1913[i]);
							}
...
UINT32 HI846PD1913_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	HI846PD1913_MIPI_RAW_SensorInit	*/
