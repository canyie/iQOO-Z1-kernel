...
#endif
#if defined(S5KGM1STPD1986_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGM1STPD1986_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(S5K3P9SP04PD1986_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3P9SP04PD1986_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_1100, 1},
...
#endif
#if defined(OV8856PD1986_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV8856PD1986_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(GC2375HPD1986_MIPI_RAW)
		{
			SENSOR_DRVNAME_GC2375HPD1986_MIPI_RAW,
			{
