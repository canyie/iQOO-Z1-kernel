...
#define PFX "SUB2[0846]_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.custom1 = {
		...
		.grabwindow_height = 1944,	 /*1944record different mode's height of grabwindow*/
		/*	 following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario	*/
		.mipi_data_lp2hs_settle_dc = 14,	
		.mipi_pixel_rate = 287700000,
		.max_framerate = 300,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] =
{
	...
	{ 3264, 2448, 	0,  252,	 3264, 1944, 3264, 1944, 336, 0, 2592, 1944,  0,  0, 2592, 1944}, // custom1		
	{ 3264, 2448,	0,		0,	 3264, 2448, 1632, 1224, 0, 0, 1632, 1224,  0,  0, 1632, 1224}, // custom2	  
};

/****vivo caofeixiang add for CameraEM otp errorcode****/
extern int vivo_sub2_otp_read(void);
int vivo_sub2_otp_read_when_power_on;
extern otp_error_code_t SUB2_OTP_ERROR_CODE_HI846SUB2;
MUINT32  sn_inf_sub2_hi846sub2[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_hi846sub2[4];  
			...
			do {
				*sensor_id = return_sensor_id() + 3;
				if (*sensor_id == imgsensor_info.sensor_id) {				
					...
					sensor_init();
					/*vivo caofeixiang add for CameraEM otp errorcode*/
					PK_DBG("cfx_add:start read eeprom ---vivo_sub2_otp_read_when_power_on = %d\n", vivo_sub2_otp_read_when_power_on);
					vivo_sub2_otp_read_when_power_on = vivo_sub2_otp_read();
					PK_DBG("cfx_add:end read eeprom ---vivo_sub2_otp_read_when_power_on = %d,SUB2_OTP_ERROR_CODE_HI846SUB2 =%d\n", vivo_sub2_otp_read_when_power_on,SUB2_OTP_ERROR_CODE_HI846SUB2);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	(struct SENSOR_WINSIZE_INFO_STRUCT *) (uintptr_t) (*(feature_data + 1));
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    PK_DBG("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  SUB2_OTP_ERROR_CODE_HI846SUB2:%d \n", *feature_data,SUB2_OTP_ERROR_CODE_HI846SUB2);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = SUB2_OTP_ERROR_CODE_HI846SUB2;//otp_state
					memcpy( feature_data+2, sn_inf_sub2_hi846sub2, sizeof(MUINT32)*13); 
				    memcpy( feature_data+10, material_inf_main_hi846sub2, sizeof(MUINT32)*4); 
					#if 0
							for (i = 0 ; i<12 ; i++ ){
							printk("sn_inf_sub2_hi846sub2[%d]= 0x%x\n", i, sn_inf_sub2_hi846sub2[i]);
							}
...
UINT32 HI846SUB2_MIPI_RAW_SensorInit(
