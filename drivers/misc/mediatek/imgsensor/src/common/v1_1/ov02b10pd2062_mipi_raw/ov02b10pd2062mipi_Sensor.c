...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10PD2062_SENSOR_ID,
...
extern int ov02b10pd2062_otp_read(void);
extern otp_error_code_t OV02B10PD2062_OTP_ERROR_CODE;
MUINT32  sn_inf_main_ov02b10pd2062[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_ov02b10pd2062[4];  
 ...
 ********************************************************/
	...
	case IMAGE_H_MIRROR://GbBGrR
		write_cmos_sensor_8_8(0xfd,0x01);
		write_cmos_sensor_8_8(0x12,0x10);
		break;
	...
	case IMAGE_HV_MIRROR://RGrGbB
		write_cmos_sensor_8_8(0xfd,0x01);
		write_cmos_sensor_8_8(0x12,0x11);
		break;
	default:
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				PK_DBG("ov02b10 start read eeprom ---vivo_otp_read_when_power_on = %d\n", vivo_otp_read_when_power_on);
				vivo_otp_read_when_power_on = ov02b10pd2062_otp_read();
				PK_DBG("ov02b10 read eeprom ---vivo_otp_read_when_power_on = %d,OV02B10PD2062_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV02B10PD2062_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV02B10PD2062_OTP_ERROR_CODE:%d \n", *feature_data,OV02B10PD2062_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV02B10PD2062_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_ov02b10pd2062, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_ov02b10pd2062, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_ov02b10pd2062[%d]= 0x%x\n", i, sn_inf_main_ov02b10pd2062[i]);
						}
				#endif
			}
				break;
...
UINT32 OV02B10PD2062_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      OV02B10PD2062_MIPI_RAW_SensorInit      */
