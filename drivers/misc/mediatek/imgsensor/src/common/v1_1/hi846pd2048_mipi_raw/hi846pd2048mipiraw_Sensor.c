...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846PD2048_SENSOR_ID,
...
extern int vivo_main3_otp_read_pd2048(void);
int vivo_main3_otp_read_when_power_on_pd2048;
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI846PD2048;
MUINT32  sn_inf_main2_hi846pd2048[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_hi846pd2048[4];  
			...
			do {
				*sensor_id = return_sensor_id()+4;
				if (*sensor_id == imgsensor_info.sensor_id) {				
					...
					sensor_init();
					/*vivo caofeixiang add for CameraEM otp errorcode*/
					PK_DBG("cfx_add:start read eeprom ---vivo_main3_otp_read_when_power_on_pd2048 = %d\n", vivo_main3_otp_read_when_power_on_pd2048);
					vivo_main3_otp_read_when_power_on_pd2048 = vivo_main3_otp_read_pd2048();
					PK_DBG("cfx_add:end read eeprom ---vivo_main3_otp_read_when_power_on = %d,MAIN3_OTP_ERROR_CODE_HI846PD2048 =%d\n", vivo_main3_otp_read_when_power_on_pd2048,MAIN3_OTP_ERROR_CODE_HI846PD2048);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	(struct SENSOR_WINSIZE_INFO_STRUCT *) (uintptr_t) (*(feature_data + 1));
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    PK_DBG("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OTP_ERROR_CODE_HI846PD2048:%d \n", *feature_data,MAIN3_OTP_ERROR_CODE_HI846PD2048);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI846PD2048;//otp_state
					memcpy( feature_data+2, sn_inf_main2_hi846pd2048, sizeof(MUINT32)*13); 
				    memcpy( feature_data+10, material_inf_main_hi846pd2048, sizeof(MUINT32)*4); 
					#if 0
							for (i = 0 ; i<12 ; i++ ){
							printk("sn_inf_main2_hi846pd2048[%d]= 0x%x\n", i, sn_inf_main2_hi846pd2048[i]);
							}
...
UINT32 HI846PD2048_MIPI_RAW_SensorInit(
