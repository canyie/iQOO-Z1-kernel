...
#if defined(CONFIG_MTK_CAM_PD2078F_EX)
...
/*xuyuanwen add start*/
#if defined(S5KGW3SP13PD2078_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGW3SP13PD2078_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 1},
...
#endif
#if defined(S5KGH1SM24PD2078_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGH1SM24PD2078_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(S5K3P9SP04PD2078_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3P9SP04PD2078_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_1050, 1},
...
#endif
#if defined(OV8856PD2078_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV8856PD2078_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(OV02B10PD2078_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV02B10PD2078_MIPI_RAW,
		{	
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(GC02M1BPD2078_MIPI_MONO)
	{
		SENSOR_DRVNAME_GC02M1BPD2078_MIPI_MONO,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(S5KGW3SP13PD2062_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGW3SP13PD2062_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(S5KGH1SM24PD2062_MIPI_RAW)
		{
		   SENSOR_DRVNAME_S5KGH1SM24PD2062_MIPI_RAW,
		   {
			   {RST, Vol_Low, 1},
			   {DOVDD, Vol_1800, 1},
			   {AVDD, Vol_2800, 1},
...
#endif
#if defined(OV8856PD2062_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV8856PD2062_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(HI846PD2062_MIPI_RAW)
		{
			SENSOR_DRVNAME_HI846PD2062_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{AVDD, Vol_2800, 0},
				{DVDD, Vol_1200, 0},
...
#endif
#if defined(OV02B10PD2062_MIPI_RAW)
		{
			SENSOR_DRVNAME_OV02B10PD2062_MIPI_RAW,
			{	
				{RST, Vol_Low, 1},
				{DOVDD, Vol_1800, 1},
				{AVDD, Vol_2800, 1},
